...
insert into splitemapp.group_status	(id,cod,title) 
values 									(1,'active','Activo'),
										(2,'disabled','Desactivado'),
										(3,'deleted','Borrado');

-- Populating user_to_group_status alter table
insert into splitemapp.user_to_group_status	(id,cod,title) 
values											(1,'active','Activo'),
												(2,'removed','Eliminado'),
...
insert into splitemapp.project	(id,status_id,type_id,title,img_cover,budget,created_at,updated_at) 
...
insert into splitemapp."group"	(id,status_id,cod,title,img_cover,created_at,updated_at) 
